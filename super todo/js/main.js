...
document.body.addEventListener('click', (event) => {
    ...
    if(clickedEl.dataset.task === "view"){
        ...
        let todo =  storage.getAllTodos().find(item => item.id == todoId)
...
function createTodoDescription(todo){
    ...
    badgeIsCompleted.textContent = todo.isCompleted ? "Bajarilgan" : "Bajarilmagan"
    badgeIsCompleted.className = todo.isCompleted ? "w-auto p-1 bg-success text-white" :"p-1 bg-danger text-white"
